...
2048 here: https://github.com/teracyhq/dev/blob/v0.4.x/vagrant_config.json#L92 on
...
#.  `Virtualbox` Installation:
    ...
    You could install any versions of Virtualbox. As for teracy-dev v0.4.x, we use virtualbox v4.3.20.
