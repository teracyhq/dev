...
::
    ...
    $ cd /tmp && wget -qO- https://raw.github.com/teracy-official/dev/v0.4.x/scripts/setup_working_env_chef.sh | bash

On Windows (Windows 7 & Windows 8), follow these steps:

1. Open: https://raw.github.com/teracy-official/dev/v0.4.x/scripts/setup_vagrant_and_virtualbox.bat on Chrome or Firefox.
