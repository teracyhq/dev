...
%w{ magic_shell nodejs npm rbenv ark python java maven php git ssh_known_hosts }.each do |dep|
    depends dep
end
...
recipe 'teracy-dev::system_python', 'Installs system-wide Python packages.'
