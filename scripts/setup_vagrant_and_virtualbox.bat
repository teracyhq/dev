...
powershell -Command "(New-Object Net.WebClient).DownloadFile('https://raw.githubusercontent.com/teracy-official/dev/v0.4.x/scripts/Download-File.ps1', 'c:\dp.ps1')"
